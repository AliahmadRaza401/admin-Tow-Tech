                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                                ...
                                child: Text("WithIn City", style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 17,
                                    color: withInCity ? Colors.white : Colors.white54
                                ),
                                )
                            ),
                          )
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                                ...
                                child: Text("City To City", style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 17,
                                  color: withInCity ? Colors.white54 : Colors.white
                                ),
                                )
                            ),
                          )
